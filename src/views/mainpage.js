...
export default class MenuScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      heightBotton:
        Dimensions.get('window').height / 13 > 50 ? Dimensions.get('window').height / 13 : 50,
      ...
      <ScrollView style={styles.container}>
        <TouchableOpacity
          style={[
            ...
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'DashboardScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'DashboardScreen'),
                },
              ]}
            />
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'TasksScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'TasksScreen'),
                },
              ]}
            />
            <AntDesign
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'AlertsScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'AlertsScreen'),
                },
              ]}
            />
            <Feather
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'YieldScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'YieldScreen'),
                },
              ]}
            />
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'StrategiesScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'StrategiesScreen'),
                },
              ]}
            />
            <MaterialCommunityIcons
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'HarvestLogScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'HarvestLogScreen'),
                },
              ]}
            />
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'SettingsScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'SettingsScreen'),
                },
              ]}
            />
            <AntDesign
        ...
        <TouchableOpacity
          style={[
            styles.touchableContainer,
            {
              height: this.state.heightBotton,
              backgroundColor:
                this.state.currentScreenId == 'SupportScreen'
                  ? this.colorOnButtonSelected
                  : '#F5FCFF',
            },
          ]}
          ...
          <View style={styles.buttonView}>
            <View
              style={[
                ...
                {
                  height: this.state.heightBotton,
                  width: this.buttonMarkWidth * (this.state.currentScreenId == 'SupportScreen'),
                },
              ]}
            />
            <FontAwesome5
